...
class ScanResults3 extends StatefulWidget {
  const ScanResults3({super.key,required this.name,required this.result,required this.param,required this.print, required this.report, required this.type});
  final ScanResult result;
  final String param, print, report, name, type;
  @override
  ScanResults3State createState() => ScanResults3State();
}

class ScanResults3State extends State<ScanResults3>{
  ...
  Widget build(BuildContext context) {
    ...
    var manufacturerData = Uint8List.fromList(widget.result.advertisementData.serviceData[Guid("2a6e")]!);

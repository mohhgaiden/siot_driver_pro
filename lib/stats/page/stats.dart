...
<<<<<<< HEAD
=======
import '../../beziar_chart/bezier_chart_plus.dart';
>>>>>>> edc460f (Initial commit)
...
=======
                              image: AssetImage(
                                'assets/images/stats/chart_fg.png',
                              ),
                              fit: BoxFit.fill,
                            ),
                          ),
                                ...
                                child:
                                    items.isEmpty
                                        ...
                                        : BezierChart(
                                          ...
                                          xAxisCustomValues: List.generate(
                                            items.length,
                                          ...
                                          bubbleLabelValueBuilder:
                                              (double value) =>
                                                  '${DateTime.fromMillisecondsSinceEpoch(items.elementAt(value.toInt())["InfoDate"]).toString().substring(0, 19)}\n',
                                          series: [
                                            BezierLine(
